...
public static partial class Constants
{
    public static class FieldSize
    {
        ...
        public const int DocketNumber = 64;
        public const int ObjectIdentifier = 50;
        public const int DepotInfo = 128;
        public const int TownInfo = 24;
